...
<html lang= "es">
    ...
    <head>
        ...
        <?php 
            ...
            if (!$connection) {
                ...
                $id = $_GET['id'];
                $sql = $connection->query("SELECT * FROM pacientes WHERE registro = $id") or die (mysql_error());
    ...
    <body>
        ...
        <div id="container">
            ...
            <div >
                <form action="serch.php?user=Diana&pass=1234&auto=1" method="post" id="contact_form">
                    <div >
